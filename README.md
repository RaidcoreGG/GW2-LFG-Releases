...
## Phase 1 Features:
Immediate access to quickplay (raids & fractals) or their respective LFGs, rather than going through the nested LFG route currently implemented in the game.
